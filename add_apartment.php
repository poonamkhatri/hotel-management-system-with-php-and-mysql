...
if(isset($_POST['save'])){
    ...
    $sql = "INSERT INTO apartments (name,status) VALUES ('$name','$status')";

    if(mysqli_query($conn, $sql)){
                    session_start();
            $_SESSION['success_message'] = "Apartment has been added successfully!";
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Add Floor Form</h4>
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
            <div class="col-md-11 mx-auto">
              <div class="card">
                <form class="form-horizontal" action="add_apartment.php" id="form" method="POST">
                  <div class="card-body">
					<div class="form-row">
