...
if (isset($_POST['save'])) {
   ...
   $sql =  "UPDATE booking_types SET name='$name',status='$status' WHERE id=$id";
    
    if(mysqli_query($conn, $sql)){
                    session_start();
            $_SESSION['success_message'] = "Booking Type has been updated successfully!";
...
$result = mysqli_query($conn,"SELECT * FROM booking_types WHERE id='" . $_GET['id'] . "'");
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Update Booking Type</h4>
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
            <div class="col-md-12">
              <div class="card">
                <form class="form-horizontal" action="editBooking.php" id="form" method="POST">
