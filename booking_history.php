...
?>
 ...
 $no = $conn->query("SELECT * FROM add_rooms order by room_no asc ");
 while($row= $no->fetch_assoc()) {
	 $no_name[$row['id']] = $row['room_no'];
}
?>	
                    ...
                    while($row = mysqli_fetch_array($result)){
                        echo "<tr>";
							...
							if($row['status'] == 1) {
								...
								echo '<p class ="badge rounded-pill bg-info" style="font-size: 14px;">Check-In</p>';
								echo "</td>"; 
								} else { echo '<p class ="badge rounded-pill bg-danger" style="font-size: 14px;">Checked-Out</p>'; }
                            echo "<td>";
                               
								if($row['status'] == 0) {
											 echo '<a href="" title="" data-toggle="tooltip" onclick="return false;"><span class="btn btn-info mdi mdi-alarm-check"></span></a>';
											 } else {

                                echo '<a href="1.php?id='. $row['id'] .'" title="" data-toggle="tooltip"><span class="btn btn-primary mdi mdi-alarm-check"></span></a>';
                                     }  
                            echo "</td>"; 
