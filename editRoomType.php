...
if (isset($_POST['save'])) {
   ...
   $sql =  "UPDATE room_types SET name='$name',status='$status' WHERE id=$id";
    
    if(mysqli_query($conn, $sql)){
                    session_start();
            $_SESSION['success_message'] = "Room Type has been updated successfully!";
...
$result = mysqli_query($conn,"SELECT * FROM room_types WHERE id='" . $_GET['id'] . "'");
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Update Room Type</h4>
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
            <div class="col-md-12">
              <div class="card">
                <form class="form-horizontal" action="editRoomType.php" id="form" method="POST">
				          <input type="hidden" name="id" class="txtField" value="<?php echo $row['id']; ?>" >
                  <div class="card-body">
					<div class="form-row">
						<div class="name">Room Type</div>
							<div class="value">
								<input class="input--style-6" style="margin-bottom: 9px;" type="text" name="name" value="<?php echo $row['name']; ?>" >
							</div>
                        </div>
					 </div>
                      <div class="card-body">
