...
if(isset($_POST['save'])){
    ...
    $sql = "INSERT INTO room_types (name,status) VALUES ('$name','$status')";

    if(mysqli_query($conn, $sql)){
                    session_start();
            $_SESSION['success_message'] = "Room Type has been added successfully!";
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Add Room Type Form</h4>
        ...
        <div class="container-fluid">
		  ...
		  <div class="row">
            <div class="col-md-12">
              <div class="card">
                <form class="form-horizontal" action="add_roomtype.php" id="form" method="POST">
                  <div class="card-body">
					<div class="form-row">
