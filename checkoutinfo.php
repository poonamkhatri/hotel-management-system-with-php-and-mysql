    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
            <form class="form-horizontal" action="checkoutinfo.php" id="form" method="POST"  enctype="multipart/form-data">
              ...
              <!--?php if($row["guest_type"]==1){ echo "First time visit";} elseif($row["guest_type"]==2)
							{ echo "Repeated stay";}
							?-->
							</p><td>
						</div>
              ...
              <!--?php if($row["stay_type"]==1){ echo "Primary";} elseif($row["stay_type"]==2)
							{ echo "Extension ";}
							?-->
							</p><td>
						</div>
              ...
              <!--?php if($row["booking_source"]==1){ echo "Air BNB ";} elseif($row["booking_source"]==2)
							{ echo "Bookings.com";}  elseif($row["booking_source"]==3)
							{ echo "GO IBIBO ";}  elseif($row["booking_source"]==4)
							{ echo "Make My Trip";}  elseif($row["booking_source"]==5)
							{ echo "Walk-in";}  elseif($row["booking_source"]==6)
							{ echo "Collaborated Corporate Guest";}
							?--></p><td>
						</div>
          ...
          <tr>
              ...
              <!--?php if($row["stay_type"]==1){ echo "Primary";} elseif($row["stay_type"]==2)
						...
						<div class="form-group">
							...
							<td><p><?php echo $row["remainamount"]; ?>
              ...
              <!--?php if($row["stay_type"]==1){ echo "Primary";} elseif($row["stay_type"]==2)
						...
						<div class="form-group">
							...
							<td><div class="col-md-6">
								...
								<input class="input--style-6" type="text" name="ckeckoutamt" style="margin-bottom: 9px;" id="ckeckoutamt" value=" <?php echo $row["remainamount"]; ?>  "  >
                    ...
                    <button type="submit" name="save" class="btn btn-success text-white"><i class="fas fa-save"></i> update</button>
                    
					          <!--a type="button" class="btn btn-danger" href="<!?php echo $_SERVER['HTTP_REFERER'] ?>"><i class="fas fa-reply"></i>Back</a-->
                    
                    <!--a href="checkout.php?id='. $row['id'] .'" title="" data-toggle="tooltip"><span class="btn btn-primary mdi mdi-alarm-check"> checkout</span></a-->
